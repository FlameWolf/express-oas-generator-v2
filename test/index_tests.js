...
it("WHEN mongoose models are supplied THEN the definitions and tags should be included", done => {
	...
	generator.init(app, spec => spec, "api-spec.json", 1000, "custom-docs", mongooseModels);
...
it("WHEN swaggerDocumentOptions is set with custom css .init()", done => {
	...
	generator.init(app, spec => spec, "api-spec.json", 1000, "api-docs", mongooseModels, null, null, null, null, { customCss: ".customCssClass { display: none }" });
