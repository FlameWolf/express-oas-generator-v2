// Type definitions for express-oas-generator-v2 1.0.17
// Project: https://github.com/mpashkovskiy/express-oas-generator-v2
...
export interface HandleResponsesOptions {
	...
	predefinedSpec?: object | OpenAPIV2.Document | OpenAPIV3.Document | ((spec: OpenAPIV2.Document) => OpenAPIV2.Document) | ((spec: OpenAPIV3.Document) => OpenAPIV3.Document);
 ...
 *
 * See
 * https://github.com/mpashkovskiy/express-oas-generator-v2/pull/32#issuecomment-546807216
 *
 * @description initialize the `express-oas-generator-v2`.
 *
 * This will apply both `handleResponses` and `handleRequests`
 * and also will call `serveApiDocs`.
 */
export function init(expressApp: Express, predefinedSpec?: HandleResponsesOptions["predefinedSpec"], specOutputPath?: HandleResponsesOptions["specOutputPath"], writeIntervalMs?: HandleResponsesOptions["writeIntervalMs"], swaggerUiServePath?: HandleResponsesOptions["swaggerUiServePath"], mongooseModels?: HandleResponsesOptions["mongooseModels"], tags?: HandleResponsesOptions["tags"], ignoredNodeEnvironments?: HandleResponsesOptions["ignoredNodeEnvironments"], alwaysServeDocs?: HandleResponsesOptions["alwaysServeDocs"], specOutputFileBehavior?: HandleResponsesOptions["specOutputFileBehavior"], swaggerDocumentOptions?: HandleResponsesOptions["swaggerDocumentOptions"]): void;
